  ...
  (mediaLeft || mediaRight) && (
    <section className="container mx-auto bg-light ">
      <div className="grid lg:grid-cols-2">
        <Image classes="w-full cover  object-contain" baseURL={mediaLeft} alt={altTextLeft} />
        <Image classes="w-full cover  object-contain" baseURL={mediaRight} alt={altTextRight} />
      </div>
    </section>
  );
